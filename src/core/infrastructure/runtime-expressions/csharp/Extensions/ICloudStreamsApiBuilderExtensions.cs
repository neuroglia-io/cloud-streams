...
public static class ICloudStreamsApiBuilderExtensions
{
    ...
    /// <summary>
    /// Configures Cloud Streams to use the CSharp implementation of the <see cref="IExpressionEvaluator"/> interface
    /// </summary>
    ...
    public static ICloudStreamsApplicationBuilder UseCSharpExpressionEvaluator(this ICloudStreamsApplicationBuilder builder)
    {
        builder.Services.TryAddSingleton<IExpressionEvaluator, CSharpExpressionEvaluator>();
        return builder;
    }
