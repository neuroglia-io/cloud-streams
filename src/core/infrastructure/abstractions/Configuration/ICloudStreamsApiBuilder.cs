...
/// </summary>
public interface ICloudStreamsApiBuilder
{
    ...
    ICloudStreamsApiBuilder RegisterMediationAssembly<TMarkup>();
    ...
    ICloudStreamsApiBuilder UseCloudEventStore<TStore>()
    ...
    /// <returns>The configured <see cref="ICloudEventStore"/></returns>
    ICloudStreamsApiBuilder UseResourceRepository<TRepository>()
    ...
    /// <returns>The configured <see cref="ICloudEventStore"/></returns>
    ICloudStreamsApiBuilder UseSchemaRegistry<TRegistry>()
