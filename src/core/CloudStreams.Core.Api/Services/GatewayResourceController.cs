...
public class GatewayResourceController
    : ResourceController<Gateway>
{

    /// <inheritdoc/>
    public GatewayResourceController(IServiceProvider serviceProvider, ILoggerFactory loggerFactory, IOptions<ResourceControllerOptions<Gateway>> controllerOptions, IRepository repository) 
