...
public static class IEventStoreExtensions
{
    ...
    /// </summary>
    /// <param name="events">The <see cref="IEventStore"/> to read the event from</param>
    ...
    public static async Task<CloudEventRecord?> ReadOneAsync(this IEventStore events, StreamReadDirection direction, long offset, CancellationToken cancellationToken = default)
    {
