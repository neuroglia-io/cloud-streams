...
public interface ICloudStreamsApplicationBuilder
{
    ...
    /// <summary>
    /// Configures Cloud Streams to use the specified <see cref="IExpressionEvaluatorProvider"/>
    /// </summary>
    /// <typeparam name="TProvider">The type of <see cref="IExpressionEvaluatorProvider"/> to use</typeparam>
    /// <returns>The configured <see cref="ICloudStreamsApplicationBuilder"/></returns>
    ICloudStreamsApplicationBuilder UseExpressionEvaluatorProvider<TProvider>()
        where TProvider : class, IExpressionEvaluatorProvider;

    /// <summary>
    /// Configures Cloud Streams to use the specified <see cref="IEventStoreProvider"/>
    /// </summary>
    /// <typeparam name="TProvider">The type of <see cref="IEventStoreProvider"/> to use</typeparam>
    /// <returns>The configured <see cref="ICloudStreamsApplicationBuilder"/></returns>
    ICloudStreamsApplicationBuilder UseEventStoreProvider<TProvider>()
        where TProvider : class, IEventStoreProvider;

    /// <summary>
    /// Configures Cloud Streams to use the specified <see cref="ISchemaRegistryProvider"/>
    /// </summary>
    /// <typeparam name="TRegistry">The type of <see cref="ISchemaRegistryProvider"/> to use</typeparam>
    /// <returns>The configured <see cref="ICloudStreamsApplicationBuilder"/></returns>
    ICloudStreamsApplicationBuilder UseSchemaRegistryProvider<TRegistry>()
        where TRegistry : class, ISchemaRegistryProvider;
