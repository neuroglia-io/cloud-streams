    ...
    : ICloudEventsApi, ICloudEventPartitionsApi, ICloudEventStreamApi
{
    ...
    /// <inheritdoc/>
    public virtual async Task<IAsyncEnumerable<PartitionMetadata?>> ListPartitionsByTypeAsync(CloudEventPartitionType type, CancellationToken cancellationToken = default)
    {
        ...
        return Serializer.Json.DeserializeAsyncEnumerable<PartitionMetadata>(responseStream, cancellationToken: cancellationToken);
    }
