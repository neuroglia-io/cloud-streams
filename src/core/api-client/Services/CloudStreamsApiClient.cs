...
/// <summary>
/// Represents the default implementation of the <see cref="ICloudStreamsApiClient"/> interface
/// </summary>
public partial class CloudStreamsApiClient
    : ICloudStreamsApiClient
{

    /// <summary>
    /// Initializes a new <see cref="CloudStreamsApiClient"/>
    /// </summary>
    /// <param name="loggerFactory">The service used to create <see cref="ILogger"/>s</param>
    /// <param name="httpClient">The service used to perform http requests</param>
    public CloudStreamsApiClient(ILoggerFactory loggerFactory, HttpClient httpClient)
    {
    ...
    ICloudEventsApi ICloudStreamsApiClient.CloudEvents => this;
