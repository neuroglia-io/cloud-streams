...
public static class ICloudStreamsApiBuilderExtensions
{
    ...
    /// <summary>
    /// Configures Cloud Streams to use the <see href="https://stedolan.github.io/jq/">JQ</see> implementation of the <see cref="IExpressionEvaluatorProvider"/> interface
    /// </summary>
    ...
    {
        builder.Services.TryAddSingleton<IExpressionEvaluatorProvider, JQExpressionEvaluator>();
        return builder;
    }
