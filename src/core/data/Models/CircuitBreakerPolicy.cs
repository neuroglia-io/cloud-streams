...
public class CircuitBreakerPolicy
{
    ...
    /// </summary>
    [Required]
    [DataMember(Order = 1, Name = "breakAfter", IsRequired = true), JsonPropertyName("breakAfter"), YamlMember(Alias = "breakAfter")]
    ...
    [DataMember(Order = 2, Name = "breakDuration", IsRequired = true), JsonPropertyName("breakDuration"), YamlMember(Alias = "breakDuration")]
