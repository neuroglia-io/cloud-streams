    ...
    : IExtensible
{
    ...
    [DataMember(Order = 1, Name = "id", IsRequired = true), JsonPropertyName("id"), YamlMember(Alias = "id")]
    ...
    [DataMember(Order = 2, Name = "specversion"), JsonPropertyName("specversion"), YamlMember(Alias = "specversion")]
    ...
    /// </summary>
    [DataMember(Order = 3, Name = "time"), JsonPropertyName("time"), YamlMember(Alias = "time")]
    ...
    /// </summary>
    [Required, JsonRequired]
    [DataMember(Order = 3, Name = "source", IsRequired = true), JsonPropertyName("source"), YamlMember(Alias = "source")]
    ...
    /// </summary>
    [Required, JsonRequired]
    [DataMember(Order = 4, Name = "type", IsRequired = true), JsonPropertyName("type"), YamlMember(Alias = "type")]
    ...
    /// </summary>
    [DataMember(Order = 5, Name = "subject"), JsonPropertyName("subject"), YamlMember(Alias = "subject")]
    ...
    [DataMember(Order = 6, Name = "datacontenttype"), JsonPropertyName("datacontenttype"), YamlMember(Alias = "datacontenttype")]
    ...
    /// </summary>
    [DataMember(Order = 7, Name = "dataschema"), JsonPropertyName("dataschema"), YamlMember(Alias = "dataschema")]
    ...
    /// </summary>
    [DataMember(Order = 8, Name = "data"), JsonPropertyName("data"), YamlMember(Alias = "data")]
    ...
    /// </summary>
    [DataMember(Order = 9, Name = "data_base64"), JsonPropertyName("data_base64"), YamlMember(Alias = "data_base64")]
    ...
    /// </summary>
    [DataMember(Order = 10, Name = "extensionAttributes"), JsonExtensionData]
