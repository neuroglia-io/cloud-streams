...
public class CloudEventMetadataPropertyResolver
{
    ...
    public CloudEventMetadataPropertyResolver(string name, CloudEventAttributeFilter attribute)
    {
        ...
        this.Name = name;
        this.Strategy = CloudEventMetadataPropertyResolutionStrategy.ContextAttribute;
    ...
    public CloudEventMetadataPropertyResolver(string name, string expression)
    {
        ...
        this.Name = name;
        this.Strategy = CloudEventMetadataPropertyResolutionStrategy.RuntimeExpression;
