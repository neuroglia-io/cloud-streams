...
public class BrokerDispatchConfiguration
{
    ...
    [DataMember(Order = 1, Name = "retryPolicy", IsRequired = true), JsonPropertyName("retryPolicy"), YamlMember(Alias = "retryPolicy")]
    public virtual HttpClientRetryPolicy RetryPolicy { get; set; } = null!;
