    ...
    : BackgroundService, ICloudEventAdmissionControl, IDisposable
{
    ...
    public CloudEventAdmissionControl(IServiceProvider serviceProvider, ILoggerFactory loggerFactory, IOptions<GatewayOptions> gatewayOptions, IJsonSerializer serializer, IGatewayMetrics metrics, ICloudEventAuthorizationManager authorizationManager,
    ...
    /// </summary>
    protected ICloudEventAuthorizationManager AuthorizationManager { get; }

    /// <summary>
    /// Gets the service used to generate <see cref="JsonSchema"/>s
    /// </summary>
    protected IJsonSchemaGenerator SchemaGenerator { get; }

    /// <summary>
    /// Gets the service used to register and manage <see cref="JsonSchema"/>s
    /// </summary>
    protected IJsonSchemaRegistry SchemaRegistry { get; }
